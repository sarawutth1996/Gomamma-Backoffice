        ...
        <>
            <Box pt={0} pb={0}>
                <Box className={classes.displayflex}>
                    <FileCopy />
                    <Typography className={classes.font_header}>รายงาน Partner</Typography>
                </Box>
            </Box>
            <PageLine />
            <br />
...
export default function Report_partner_master() {
    const url = config.API_URL + "models/Report/Report_partner.php";
