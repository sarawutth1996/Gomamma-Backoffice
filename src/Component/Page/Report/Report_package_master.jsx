        ...
        <>
            <Box pt={0} pb={0}>
                <Box className={classes.displayflex}>
                    <FileCopy />
                    <Typography className={classes.font_header}>รายงานคูปองทริป</Typography>
                </Box>
            </Box>
            <PageLine />
            <br />
...
export default function Report_package_master() {
    const url = config.API_URL + "models/Report/Report_package.php";
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={12} sm={6} >
                                            <Autocomplete
                                                ...
                                                options={Datauser}
                                                getOptionLabel={(value) => value.gmm_package_id}
                                                getOptionSelected={(option, value) =>
                                                    option.gmm_package_id === value.gmm_package_id
                                                }
                                                value={Form.SortID}
                                                ...
                                                renderOption={(option) => {
                                                    return (
                                                        <>
                                                            <span className={classes.fontsmall}>  {option.gmm_package_id + ' :: ' + option.gmm_package_name}</span>
                                                        </>
                                                    );
                                                }}
                                                renderInput={(params) => (
