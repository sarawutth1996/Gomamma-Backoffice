...
import {
    Backdrop, Button, Box, Card, CardContent, FormControl, FormLabel, Typography, Grid,
        ...
        <>
            <Box pt={0} pb={0}>
                <Box className={classes.displayflex}>
                    <FileCopy />
                    <Typography className={classes.font_header}>รายงานจำนวนการค้นหา</Typography>
                </Box>
            </Box>
            <PageLine />
            <br />
...
export default function Report_count() {
    const url = config.API_URL + "models/Report/Report_count.php";
