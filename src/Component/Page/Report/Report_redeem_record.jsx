        ...
        <>
            <Box pt={0} pb={0}>
                <Box className={classes.displayflex}>
                    <FileCopy />
                    <Typography className={classes.font_header}>รายงานแลกของรางวัล</Typography>
                </Box>
            </Box>
            <PageLine />
            <br />
...
export default function Report_redeem_record() {
    const url = config.API_URL + "models/Report/Report_redeem.php";
