        ...
        <>
            <Box pt={0} pb={0}>
                <Box className={classes.displayflex}>
                    <FileCopy />
                    <Typography className={classes.font_header}>รายงานส่วนลดโปรโมชั่น</Typography>
                </Box>
            </Box>
            <PageLine />
            <br />
...
export default function Report_promotion_master() {
    const url = config.API_URL + "models/Report/Report_promotion.php";
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={12} sm={6} >
                                            <Autocomplete
                                                ...
                                                options={Datauser}
                                                getOptionLabel={(value) => value.gmm_promotion_id}
                                                getOptionSelected={(option, value) =>
                                                    option.gmm_promotion_id === value.gmm_promotion_id
                                                }
                                                value={Form.SortID}
                                                ...
                                                renderOption={(option) => {
                                                    return (
                                                        <>
                                                            <span className={classes.fontsmall}>  {option.gmm_promotion_id + ' :: ' + option.gmm_promotion_name}</span>
                                                        </>
                                                    );
                                                }}
                                                renderInput={(params) => (
