...
export default function Dialog_edit_profile({ edit, setEdit, edit_name, setNameEdit, pid, uid }) {
    ...
    async function SaveData(status) {
        ...
        if (res.status) {
            ...
            if (res.message === 'อัพเดทข้อมูลสำเร็จ') {
                let fullname = Form.fname + ' ' + Form.lname
                setEdit(!edit)
                setNameEdit({ ...edit_name, name: fullname })
            }
        }
